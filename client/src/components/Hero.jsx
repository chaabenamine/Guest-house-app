...
const Hero = () => {
  return (
    <div className='flex flex-col items-start justify-center
     ...
     h-screen'>
      <p className='bg-[#49B9FF]/50 px-3.5 pu-1 rounded-full mt-20'> The Ultimate Guest House Experience </p>
      ...
      <p className=' max-w-130 mt-2 text-sm md:text-base'>Unparalleled luxury and comfort await at the world's most exclusive Guest Houses and resorts. Start your journey today.</p>
